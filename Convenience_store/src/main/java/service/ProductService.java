...
public interface ProductService {
    ...
    Product createProduct(String productName, String category, String baseUnit, BigDecimal importPrice, BigDecimal markupRate) throws SQLException;
    ...
    ProductUnit addUnit(int productId, String unitName, int ratio, String barcode, BigDecimal sellingPrice, boolean isDefault) throws SQLException;
