...
public class ClientInfoUtil {
    ...
    public static String getClientIP() {
        try {
            // Thử lấy Public IP (IP mạng Internet bên ngoài) bằng API miễn phí, nhanh và ổn định
            ...
            try {
                // Nếu máy không có mạng Internet (chỉ chạy mạng LAN nội bộ), lấy IP của máy trong mạng LAN
