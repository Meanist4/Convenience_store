...
public class AddProductFrame extends javax.swing.JFrame {
                ...
                try {
                    ...
                    if (!impPriceStr.isEmpty() && !ratioStr.isEmpty() && !sellPriceStr.isEmpty()) {
                        ...
                        if (importPrice.compareTo(java.math.BigDecimal.ZERO) > 0 && ratio > 0) {
                            ...
                            java.math.BigDecimal calculatedSellPricePerBox = sellingPricePerUnit.multiply(new java.math.BigDecimal(ratio));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addComponent(discountTxt1, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(49, 49, 49)
                        .addComponent(sellPriceTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(catTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(223, 223, 223)
                        .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(12, 12, 12)
                        .addComponent(ratioTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(proTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(113, 113, 113)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(83, 83, 83)
                        .addComponent(addImgBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblImagePreview, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(132, 132, 132)))
                .addContainerGap(51, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(addProBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(268, 268, 268)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(discountTxt1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(15, 15, 15)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(addImgBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 95, Short.MAX_VALUE)
                        .addComponent(addProBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lblImagePreview, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addProBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addProBtnMouseClicked
        ...
        // Nếu không quét mã vạch thì bắt buộc phải chuyển về null để tránh lỗi UNIQUE của DB
        if (barcode.isEmpty()) {
            barcode = null;
        }

        // Kiểm tra tính hợp lệ: Không được để trống các trường bắt buộc
        if (proName.isEmpty() || impPriceStr.isEmpty() || ratioStr.isEmpty() || sellPriceStr.isEmpty() || impUnit.isEmpty() || sellUnit.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ toàn bộ thông tin sản phẩm và quy đổi trên Form!");
            return;
        }
        ...
        try {
            ...
            if (selectedImagePath != null) {
                ...
                if (sourceFile.exists()) {
                    ...
                    java.nio.file.Files.copy(sourceFile.toPath(), srcDestFile.toPath(), java.nio.file.StandardCopyOption.REPLACE_EXISTING);
                    ...
                    try {
                        ...
                        if (resource != null) {
                            ...
                            java.nio.file.Files.copy(sourceFile.toPath(), targetDestFile.toPath(), java.nio.file.StandardCopyOption.REPLACE_EXISTING);
                        }
                    } catch (Exception e) {
            ...
            JOptionPane.showMessageDialog(this, "Định dạng số không hợp lệ! Vui lòng kiểm tra lại các ô Giá nhập, Giá bán và Tỉ lệ.");
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void scanBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scanBtnActionPerformed
        ...
        // 3. Tạo một Thread (luồng chạy ngầm) để chụp ảnh từ camera và phân tích mã liên tục
                ...
                while (webcam.isOpen()) {
                    ...
                    if (image != null) {
                        ...
                        try {
                            ...
                            // Cứ sau vài mili-giây nếu không tìm thấy mã vạch trong khung hình thì bỏ qua, quét tiếp khung hình sau
                        }
                    }
        ...
        // Sự kiện nếu người dùng chủ động tắt cửa sổ Dialog quét đi thì phải tắt Camera ngầm
