...
public class POSFrame extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            // Dịch mã vạch sang thực thể ProductUnit
            ...
            // Vòng lặp kiểm tra xem sản phẩm này đã tồn tại trong bảng giao diện chưa
            ...
            if (existingRowIndex != -1) {
                // 🔄 TRƯỜNG HỢP TRÙNG MÃ: Tiến hành cộng dồn số lượng trên giao diện và giỏ hàng RAM
                ...
                model.setValueAt(newSubtotal + " đ", existingRowIndex, 5);

                // Cập nhật List<InvoiceDetail> ẩn dùng để gửi xuống Database
                ...
                // 🆕 TRƯỜNG HỢP MỚI: Thêm một dòng mới hoàn toàn vào bảng và giỏ hàng RAM
                ...
                // Thêm dòng mới vào table hiển thị trực quan theo các cột đã cấu hình
            ...
            // Cập nhật lại nhãn hiển thị Tổng tiền dưới chân trang (Cộng thêm phần tiền của lượt quét này)
            ...
            // Reset nhanh ô nhập để chờ lượt quét tiếp theo
            txtBarcode.setText("");
